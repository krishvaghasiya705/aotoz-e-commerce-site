      ...
      <div className="container">
        <div className="mb-4 flex justify-end gap-4">
          ...
          <FormControl variant="outlined" className="w-full max-w-[200px]">
            <InputLabel>{productType ? productType.charAt(0).toUpperCase() + productType.slice(1) : "Product Type"}</InputLabel>
            <Select
              value={productType}
              onChange={handleProductTypeChange}
              label={productType ? productType.charAt(0).toUpperCase() + productType.slice(1) : "Product Type"}
              autoSelect
              MenuProps={{
                PaperProps: {
                  style: {
