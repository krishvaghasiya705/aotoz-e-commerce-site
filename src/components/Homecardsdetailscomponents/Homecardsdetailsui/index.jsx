      ...
      <div className="border shadow-lg mb-5 rounded-lg bg-white">
        <div className="grid grid-cols-1 md:grid-cols-2 p-6 gap-6">
          <div className="w-full grid grid-cols-[50px_1fr] gap-2.5">
            <div>
              <div className="flex flex-col gap-2.5 sticky top-[80px] left-0">
                {product.images.map((image, index) => (
                  ...
                  >
                    <div
                      className="h-full bg-center bg-contain mix-blend-multiply bg-no-repeat"
                      style={{
            ...
            <div className="w-full relative mb-6 md:mb-0 h-[400px] md:h-[600px] rounded-lg shadow-lg border bg-gray-200">
              <div
                ...
                alt={product.title}
                className="max-w-full rounded-lg h-full bg-center bg-contain mix-blend-multiply bg-no-repeat cursor-pointer"
                onMouseMove={handleMouseMove}
                onMouseLeave={handleMouseLeave}
              />
              <div
                className="absolute w-[25%] h-[25%] border-2 border-gray-300 pointer-events-none z-10 rounded-lg"
                style={{
                  ...magnifyStyle,
                }}
              />
          ...
          <div className="w-full h-full relative">
            ...
            <div
              className="absolute top-0 left-0 w-full h-full border overflow-hidden bg-gray-200 rounded-xl"
              style={{ ...magnifyStyle2 }}
            >
              <div
